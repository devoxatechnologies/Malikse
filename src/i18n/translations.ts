...
const translations: Record<string, Record<string, string>> = {
  ...
  hi: {
    ...
    post_land_free: "+ ज़मीन पोस्ट करें (निःशुल्क)",
    hero_title: "असली ज़मीन एवं प्लॉट खोजें",
    hero_subtitle: "सीधे सत्यापित मालिकों से",
    trust_jamabandi: "100% जमाबंदी एवं रजिस्ट्री जांची गई",
    trust_gps: "GPS सत्यापित स्थान",
    trust_zero_brokerage: "शून्य ब्रोकरेज (दलाली मुक्त)",
